    ...
    )
{
    ...
    if( AnscEqualString(ParamName, "motion_csi_cal", TRUE))
    {
        set_cal_duration_for_each_clients((UINT)uValue);
        wifi_util_info_print(WIFI_MGR,"%s:%d set csi calibration duration in sec:%u\r\n\n",
